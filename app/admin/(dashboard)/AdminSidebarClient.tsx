      ...
      <aside className="w-full md:w-64 bg-[#091426] text-white shrink-0 border-r border-gray-800 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-800 space-y-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-2 bg-rose-950/80 hover:bg-rose-900 text-rose-200 rounded-lg text-xs font-mono transition-all border border-rose-800/50 cursor-pointer"
          >
            <span>🔒 Log Out</span>
          </button>
        </div>
